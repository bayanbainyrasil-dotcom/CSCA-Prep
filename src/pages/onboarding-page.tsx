...
export default function OnboardingPage() {
  ...
  return <div className="min-h-dvh bg-background p-4 sm:grid sm:place-items-center sm:p-6">
    <div className="w-full max-w-2xl rounded-[2rem] border bg-card p-6 shadow-float sm:p-10">
      ...
      <Progress className="mt-6" value={((step + 1) / 5) * 100} />
