...
import { READINESS_EYEBROW, READINESS_HISTORY_CAVEAT } from '@/features/dashboard/readiness-language';
import { Activity, Brain, Clock3, Languages, TrendingUp } from 'lucide-react';
import { Area, AreaChart, Bar, BarChart, CartesianGrid, Legend, ResponsiveContainer, Tooltip, XAxis, YAxis } from 'recharts';
import { PageHeading } from '@/components/layout/page-heading';
import { CoverageConfidenceCard } from '@/features/progress/coverage-confidence-card';
