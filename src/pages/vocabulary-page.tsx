...
export default function VocabularyPage() {
  ...
  return <div><PageHeading eyebrow="English for CSCA" title="Recognize the instruction before the maths." description="Smart cards alternate word, meaning and sentence contexts with adaptive review." actions={<Badge variant={isDemo?'outline':'success'}>{isDemo?'Original vocabulary set':'Published vocabulary'}</Badge>} />
