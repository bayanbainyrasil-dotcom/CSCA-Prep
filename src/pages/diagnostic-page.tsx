  ...
  const finish = async () => {
    ...
    try {
      ...
      for (const item of questions) {
        ...
        if (item.demo) {
          if (!item.correctAnswer) throw new Error('A verified demo answer is missing.');
